...
public class RelatorioEvento {
    ...
    private List<ParticipantePresenca> participantes;
    ...
    public List<ParticipantePresenca> getParticipantes() { return participantes; }
    ...
    public void setParticipantes(List<ParticipantePresenca> participantes) { this.participantes = participantes; }
}
